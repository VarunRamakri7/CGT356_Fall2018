...
<body>
    ...
    <div id="Whole">
        <form id="form0" name="form0" method="post" action="getFormData.php">
            <fieldset id="billing">
            <div id="Billing">
                <!-- Billing section of the page. It is the form for the user to fill their billing details into -->
            ...
            <div id="Billing">
                <!-- Shipping section of the page. It is the form for the user to fill their shipping details into -->
