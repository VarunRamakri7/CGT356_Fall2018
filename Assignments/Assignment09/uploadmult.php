...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        <title>Assignment 09 - Upload Multiple</title>
        ...
        <style>
            ...
            fieldset#submit { position:absolute; top:340px; left:20px; width:460px; text-align:center; }
    ...
    <body>
        <h1 style="text-align:center; font-size=16pt">Assignment 09 - Upload Multiple</h1>
        <?php
            include("includes/menu.php");
        ?>
        <form id="form0" method="post" action="doUploadMult.php" enctype="multipart/form-data">

            <fieldset id="info">
                <input type="hidden" name="src" value="uploadmult.php" />
                ...
                <ul>
                    ...
                    <li><label title="userfile1" for="userfile1">File 1:<span>*</span></label>
                        <input type="file" name="userfile1" size="25"/>
                        </li>
                    <li><label title="userfile2" for="userfile2">File 2:<span>*</span></label>
                        <input type="file" name="userfile2" size="25"/>
                        </li>
                    <li><label title="userfile3" for="userfile3">File 3:<span>*</span></label>
                        <input type="file" name="userfile3" size="25"/>
                        </li>
                    <li><label title="userfile4" for="userfile4">File 4:<span>*</span></label>
                        <input type="file" name="userfile4" size="25"/>
                        </li>
                    <li><label title="userfile5" for="userfile5">File 5:<span>*</span></label>
                        <input type="file" name="userfile5" size="25"/>
                        </li>
                    </li>
                </ul>
            </fieldset>
