...
<head>
	<title>Assignment 09 - Upload HTML</title>
...
<body>
<h1 style="text-align:center; font-size=16pt">Assignment 09 - Upload HTML</h1>
<?php include("includes/menu.php"); ?>
<!----Changed the action to the correct page.-------->
<form id="form0" method="post" action="doUploadHTML.php" enctype="multipart/form-data"> 
    <fieldset id="info">
        <input type="hidden" name="src" value="uploadhtml.php" />
