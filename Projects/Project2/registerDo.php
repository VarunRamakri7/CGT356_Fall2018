...
$db = mysqli_connect('localhost', 'ramakri7', '19fire98', 'Project2');
...
if (isset($_POST['reg_user'])) {
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO userLogin (uniqueid, username, password, accesslevel) VALUES(null, '".$username."', '".$password_1."', 'User')";
