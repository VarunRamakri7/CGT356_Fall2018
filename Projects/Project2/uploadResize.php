...
<body>
	<h1 style="text-align:center; font-size=16pt">Project 2 - Upload</h1>
			...
			<form id="form0" method="post" action="doUploadResize.php" enctype="multipart/form-data"> 
				<fieldset id="info">
					...
					<ul>
						...
						<li> <label title="description" for="desc"> Description: <span>*</span></label> <input type="text" name="desc" /><br>
						</li>
					</ul>
				</fieldset>
				<fieldset id="submit">
