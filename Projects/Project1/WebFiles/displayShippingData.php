...
{
    header("Location:shippingMain.php");
}
?>
<!DOCTYPE html>
...
<body>
<h1 style="font-size:14pt; text-indent:360px;">Shipping Info</h1>
...
<!-- Getting the shipping and billing data -->
    ...
    <div id="nav">
        ...
        <span id="nav2"><a href="finishedUpdateShipping.php">Finished Updating</a></span>
    </div>
</body>
</html>
