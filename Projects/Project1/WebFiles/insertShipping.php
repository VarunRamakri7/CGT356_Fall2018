...
<head>
    <meta charset="utf-8" />
    <title>Shipping - Insert Page</title>
    <style type="text/css">
...
<body>
    <h1 style="text-align:center;">Shipping - Insert Page</h1>
        <form id="form0" name="form0" method="post" action="insertDoShipping.php">
            <fieldset id="shipping">
                ...
                <ul>
                    ...
                    <li> <label title="State" for="state">State<span>*</span></label>
                         <input type="text" name="state" id="state" size="30" maxlength="30" /></li>
                    <li> <label title="Zip" for="zip">Zip<span>*</span></label>
                         <input type="text" name="zip" id="zip" size="30" maxlength="30" /></li>
