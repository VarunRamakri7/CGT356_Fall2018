...
<head>
    <meta charset="utf-8" />
    <title> Billing Info - Select Page </title>
</head>

<body>
    <h1 align="center">Billing Info - Select Page</h1>
    <?php 
        ...
        $sql="SELECT * FROM PaymentInformation WHERE username='".$_SESSION["login_user"]."'";
        $result= $conn->query($sql);
    ?>

    <table style="border:0px; width:500px; padding:0px; margin:0px auto; border-spacing:0px;" title="Your Billing Information">

        <thead>
            <tr>
                <th colspan="13" style="font-weight:bold; background-color:#b1946c; text-align:center; text-decoration:underline;">Your payment information</th>
            </tr>
            <tr>
                ...
                <th style="background-color:#b1946c; font-weight:bold;">Card Number</th>
                <th style="background-color:#b1946c; font-weight:bold;">Card Type</th>
                <th style="background-color:#b1946c; font-weight:bold;">Expiration Date</th>
                <th style="background-color:#b1946c; font-weight:bold;">CCV</th>
                ...
                <th style="background-color:#b1946c; font-weight:bold;">Email</th>
            </tr>

        </thead>
        <tfoot>
            <tr>
                <td colspan="13" style="text-align:center; font-style:italic">Information was pulled from the Project 1 Database</td>
            </tr>
        </tfoot>
        <tbody>
            <?php
                    ...
                    while($row = $result->fetch_assoc())
                    {
                        ...
                        <tr>
                            <td style="border-right:1px solid #000000;">
                                <a href="updateBilling.php?id=<?php echo(trim($row["uniqueid"])); ?>">edit</a> | <a href="deleteBilling.php?id=<?php echo(trim($row["uniqueid"])); ?>">delete
                            </td>
                            ...
                            <td style="border-right:1px solid #000000;"><?php echo(trim($row["expiration"])); ?></td>
                            <td style="border-right:1px solid #000000;"><?php echo(trim($row["ccv"])); ?></td>
